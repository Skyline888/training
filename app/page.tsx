  ...
  const days = [
    {
      ...
      exercises: [
        "Жим штанги лежачи (Груди) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Махи гантелями в сторони (Середня дельта) — 3×12–15",
        "Тяга верхнього блоку до грудей (Ширина спини) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Жим гантелей сидячи (Плечі — загальна маса) — 3×10–12",
        "Тяга штанги в нахилі (Товщина спини) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Кросовер / Пек-дек (Груди — розтягнення) — 4×12–15",
        "Reverse pec-deck / задня дельта в тренажері (Задня дельта / лопатка) — 3×12–20",
      ],
    },
    {
      title: "ПОНЕДІЛОК — Lower A + Arms (Колінний акцент + Прямі руки)",
      focus: "Квадрицепс/сідниці + база задньої поверхні + прямі підходи на руки",
      exercises: [
        "Гакк-присідання (Квадрицепс, сідниці) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Румунська тяга (Задня поверхня стегна, випрямлячі спини) — 3×10–12",
    ...
    },
    {
      ...
      exercises: [
        ...
        "Жим гантелей під кутом 30–45° (Верх грудей) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Горизонтальна тяга в тренажері (Середина спини) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Face Pulls (Задня дельта / Постава / Верх спини) — 4×15",
        "Тяга верхнього блоку паралельним хватом (Найширші) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Віджимання на брусах / Жим у хаммері (Низ грудей) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Махи гантелями сидячи (Середня дельта — чиста ізоляція) — 3×15",
      ],
    },
    {
      title: "П'ЯТНИЦЯ — Lower B + Arms (Тазостегновий акцент + Ширина рук)",
      focus:
        "Квадрицепс (жим ногами, випади) + задня ланка (згинання, pull-through) + руки (трицепс/брахіаліс); передпліччя — у понеділок",
      exercises: [
        "Жим ногами (Квадрицепс, сідниці) — 4×12–15",
        "Згинання ніг сидячи/лежачи (Біцепс стегна) — 3×8–10 + 1×6–8 (останній, RIR 1–0)",
        "Випади з гантелями (Сідниці, квадрицепс, стабілізатори) — 2×12/нога",
        "Cable pull-through (тяга канату між ногами) (Сідниці / задній ланцюг) — 3×10–15",
        "Розгинання рук на блоці/канат (Трицепс — латеральна головка) — 3×12",
        "Молоткові підйоми гантелей (Брахіаліс — товщина руки, біцепс) — 3×12",
